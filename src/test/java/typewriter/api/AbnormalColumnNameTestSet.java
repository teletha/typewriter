...
public interface AbnormalColumnNameTestSet extends Testable {
    ...
    class Reserved extends DerivableModel {
         ...
         */
        public void setAsymmetric(int asymmetric) {
         ...
         */
        public void setAboth(int aboth) {
            this.aboth = aboth;
        }
         ...
         */
        public void setCurrent_catalog(int current_catalog) {
            this.current_catalog = current_catalog;
        }
         ...
         */
        public void setCurrent_path(int current_path) {
         ...
         */
        public void setCurrent_schema(int current_schema) {
         ...
         */
        public void setCurrent_timestamp(int current_timestamp) {
         ...
         */
        public void setFALSE(int fALSE) {
            FALSE = fALSE;
        }
         ...
         */
        public void setHaving(int having) {
            this.having = having;
        }
         ...
         */
        public void setSystem_user(int system_user) {
         ...
         */
        public void setUESCAPE(int uESCAPE) {
            UESCAPE = uESCAPE;
        }
         ...
         */
        public void set_ROWID_(int _ROWID_) {
